---
title: 项目范围管理 - 信息系统项目管理师十大知识领域 | 软考高级备考
description: 详解项目范围管理的六大过程：规划范围管理、收集需求、定义范围、创建 WBS、确认范围和控制范围，包含输入输出及考试重点。
keywords: 项目范围管理，WBS,收集需求，定义范围，确认范围，控制范围，软考高级，信息系统项目管理师
---
