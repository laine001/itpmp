---
title: 项目进度管理 - 信息系统项目管理师十大知识领域 | 软考高级备考
description: 详解项目进度管理的六大过程：规划进度、定义活动、排列活动顺序、估算活动持续时间、制订进度计划和控制进度，包含关键路径法等核心方法。
keywords: 项目进度管理，关键路径法，进度计划，活动排序，软考高级，信息系统项目管理师
---
...
#### 数据分析
- 备选方案分析：备选方案分析用于比较不同的资源能力或技能水平、进度压缩技术、不同工具(手动和自动)，以及关于资源的创建、租赁和购买决策
