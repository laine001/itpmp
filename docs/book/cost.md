---
title: 项目成本管理 - 信息系统项目管理师十大知识领域 | 软考高级备考
description: 详解项目成本管理的四大过程：规划成本管理、估算成本、制定预算和控制成本，包含挣值管理 EVM 等核心计算方法。
keywords: 项目成本管理，挣值管理，EVM,成本估算，成本预算，软考高级，信息系统项目管理师
---
