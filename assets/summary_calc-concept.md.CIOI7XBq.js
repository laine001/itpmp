...
<span class="line"><span>|   | &gt;0: 节省, &lt;0: 超支    |  |</span></span>
<span class="line"><span>|   +----------------------+  |</span></span>
<span class="line"><span>+-----------------------------+</span></span></code></pre></div></details><h2 id="总时差、标准时差" tabindex="-1">总时差、标准时差 <a class="header-anchor" href="#总时差、标准时差" aria-label="Permalink to &quot;总时差、标准时差&quot;">​</a></h2><ul><li>标准差 = <code>(悲观 - 乐观) / 6</code> 或 <code>(大 - 小) /6</code> 必须为正值</li></ul><h2 id="六标时" tabindex="-1">六标时 <a class="header-anchor" href="#六标时" aria-label="Permalink to &quot;六标时&quot;">​</a></h2><h2 id="关键路径" tabindex="-1">关键路径 <a class="header-anchor" href="#关键路径" aria-label="Permalink to &quot;关键路径&quot;">​</a></h2><h2 id="三点估算pert" tabindex="-1">三点估算PERT <a class="header-anchor" href="#三点估算pert" aria-label="Permalink to &quot;三点估算PERT&quot;">​</a></h2><ul><li><code>期望值</code>: 通过计算得到，最期望的值 T1</li><li><code>悲观值</code>: 题目给出，最糟糕情况 T2</li><li><code>乐观值</code>: 题目给出，最好的情况 T3</li><li><code>最可能值</code>: 题目给出，一般的情况 T4 不同的地方，符号可能不一样。 期望值：T1 = (T2 + T3 + 4 * T4) / 6</li></ul>`,14)]))}const h=s(e,[["render",i]]);export{V as __pageData,h as default};
