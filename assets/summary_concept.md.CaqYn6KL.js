import{_ as o,c as i,o as t,j as n,C as r,G as p,aA as l,a as e}from"./chunks/framework.B5199-QK.js";const u={},C={border:"0"};function h(c,s){return t(),i("table",C,s[0]||(s[0]=[n("thead",null,[n("tr",null,[n("th",null,"项目管理计划"),n("th",{colspan:"2"},"项目文件")])],-1),n("tbody",null,[n("tr",null,[n("td",null,"范围管理计划"),n("td",null,"活动属性"),n("td",null,"项目团队派工单")]),n("tr",null,[n("td",null,"需求管理计划"),n("td",null,"活动清单"),n("td",null,"质量控制测量结果")]),n("tr",null,[n("td",null,"进度管理计划"),n("td",null,"假设日志"),n("td",null,"质量测量指标")]),n("tr",null,[n("td",null,"成本管理计划"),n("td",null,"估算依据"),n("td",null,"质量报告")]),n("tr",null,[n("td",null,"质量管理计划"),n("td",null,"变更日志"),n("td",null,"需求文件")]),n("tr",null,[n("td",null,"资源管理计划"),n("td",null,"成本估算"),n("td",null,"需求跟踪矩阵")]),n("tr",null,[n("td",null,"沟通管理计划"),n("td",null,"持续时间估算"),n("td",null,"资源分解结构")]),n("tr",null,[n("td",null,"风险管理计划"),n("td",null,"问题日志"),n("td",null,"资源日历")]),n("tr",null,[n("td",null,"采购管理计划"),n("td",null,"经验教训登记册"),n("td",null,"资源需求")]),n("tr",null,[n("td",null,"干系人参与计划"),n("td",null,"里程碑清单"),n("td",null,"风险登记册")]),n("tr",null,[n("td",null,"变更管理计划"),n("td",null,"物质资源分配单"),n("td",null,"风险报告")]),n("tr",null,[n("td",null,"配置管理计划"),n("td",null,"项目日历"),n("td",null,"进度数据")]),n("tr",null,[n("td",null,"范围基准"),n("td",null,"项目沟通记录"),n("td",null,"进度预测")]),n("tr",null,[n("td",null,"进度基准"),n("td",null,"项目进度计划"),n("td",null,"干系人登记册")]),n("tr",null,[n("td",null,"成本基准"),n("td",null,"项目进度网络图"),n("td",null,"团队章程")]),n("tr",null,[n("td",null,"绩效测量基准"),n("td",null,"项目范围说明书"),n("td",null,"测试与评估文件")]),n("tr",null,[n("td",null,"项目生命周期描述"),n("td"),n("td")]),n("tr",null,[n("td",null,"开发方法"),n("td"),n("td")])],-1)]))}const V=o(u,[["render",h]]),E={class:"details custom-block"},A=JSON.parse('{"title":"一些不太好记的概念和公式","description":"","frontmatter":{},"headers":[],"relativePath":"summary/concept.md","filePath":"summary/concept.md"}'),P={name:"summary/concept.md"},b=Object.assign(P,{setup(c){return(s,a)=>{const d=r("n-image");return t(),i("div",null,[a[2]||(a[2]=n("h1",{id:"一些不太好记的概念和公式",tabindex:"-1"},[e("一些不太好记的概念和公式 "),n("a",{class:"header-anchor",href:"#一些不太好记的概念和公式","aria-label":'Permalink to "一些不太好记的概念和公式"'},"​")],-1)),a[3]||(a[3]=n("p",null,"多数和计算题和案例题有关",-1)),a[4]||(a[4]=n("h2",{id:"项目管理计划和项目文件",tabindex:"-1"},[e("项目管理计划和项目文件 "),n("a",{class:"header-anchor",href:"#项目管理计划和项目文件","aria-label":'Permalink to "项目管理计划和项目文件"'},"​")],-1)),p(V),a[5]||(a[5]=l(`<h2 id="挣值分析相关" tabindex="-1">挣值分析相关 <a class="header-anchor" href="#挣值分析相关" aria-label="Permalink to &quot;挣值分析相关&quot;">​</a></h2><h3 id="ev、ac、pv、etc、eac、vac等概念" tabindex="-1">EV、AC、PV、ETC、EAC、VAC等概念 <a class="header-anchor" href="#ev、ac、pv、etc、eac、vac等概念" aria-label="Permalink to &quot;EV、AC、PV、ETC、EAC、VAC等概念&quot;">​</a></h3><ul><li><code>EV（Earned Value）</code>：即挣值，也被称作已完成工作预算成本</li><li><code>AC（Actual Cost）</code>：是实际成本，即实际完成工作所花费的成本</li><li><code>PV（Planned Value）</code>：代表计划价值，又称计划工作预算成本</li><li><code>BAC（Budget At Completion）</code>：项目完工预算，指完成项目所有工作的总预算</li><li><code>CV（Cost Variance）</code>：成本偏差，通过公式 CV = EV - AC 计算。当 CV &gt; 0 ，表示 EV 大于 AC，成本节约</li><li><code>SV（Schedule Variance）</code>：进度偏差，根据公式 SV = EV - PV 计算。SV &gt; 0 时，EV 大于 PV，项目进度提前</li><li><code>SPI（Schedule Performance Index）</code>：进度绩效指数，是项目管理中用于衡量项目进度效率的关键指标。SPI&lt;1：实际工作量小于计划工作量（滞后），大于1（进度超前） SPI = EV / PV 例：SPI为80.00%时表示进度为正常进度的80%（滞后）</li><li><code>CPI（Cost Performance Index）</code>：成本绩效指数，是项目管理中用于衡量成本效率的关键指标。CPI＞1：挣值大于实际成本，即实际成本低于预算，成本控制良好（有结余），CPI&lt;1：实际成本超预算。 CPI = EV / AC 例：CPI为1.05时 项目100元的成本创造了105元的价值</li><li><code>ETC</code>：完工尚需估算，完成剩余工作还需要的成本估算</li><li><code>EAC</code>：完工估算，完成整个项目预计需要的总成本</li></ul><h3 id="计算公式" tabindex="-1">计算公式 <a class="header-anchor" href="#计算公式" aria-label="Permalink to &quot;计算公式&quot;">​</a></h3><ul><li>CV = EV - AC &gt;0 节省</li><li>SV = EV - PV &gt;0 提前</li><li>CPI = EV / AC &gt;1 节省</li><li>SPI = EV / PC &gt;1 提前</li><li>典型：出现偏差后，还照原计划 <ul><li>ETC = (BAC - EV) / CPI</li><li>EAC = AC + ETC = AC + (BAC - EV) / CPI</li></ul></li><li>非典型：出现偏差后，纠错/改善 <ul><li>ETC = BAC - EV</li><li>EAC = AC + ETC = AC + BAC - EV</li></ul></li></ul><details class="details custom-block"><summary>非典型偏差记忆协助</summary><p>因为前期出现了偏差然后又改善了，前面的偏差属于偶然原因或事件，所以称为非典型。计算ETC的时候不用除以CPI。</p></details><details class="details custom-block"><summary>进度和成本偏差记忆协助</summary><p>计划花费10元，10天买10个苹果。</p><p>9天的时候买了8个苹果，花费了7元。 EV = 8；PV = 9；AC = 7；</p><p>由此可直接推测：成本节省，进度滞后。</p><p>CPI = EV / AC = 8 / 7 &gt; 1 成本节省； SPI = EV / PV = 8 / 9 &lt; 1 进度滞后。</p></details><details class="details custom-block"><summary>进度成本偏差时可采取措施</summary><p><code>进度滞后，成本节约</code>时可采取的措施（<code>赶快两高两减</code>）</p><ol><li><code>赶</code>工，投入更多的资源或增加工作时间，以缩短关键活动的工期（成本会增加）</li><li><code>快</code>速跟进，并行施工，以缩短关键路径的长度</li><li>使用<code>高</code>素质的资源或经验更丰富的人员</li><li><code>减</code>少活动范围或降低活动要求（甲方同意的前提）</li><li>改进方法或技术，以提<code>高</code>生产效率</li><li>加强质量管理，及时发现问题，<code>减</code>少返工，从而缩短工期</li></ol><p><code>进度滞后，成本超支</code>时： 上面六条去除第一个赶工</p><p><code>进度超前、成本超支</code>：</p><ol><li>抽出部分人员</li><li>适当降低工作效率</li><li>适当安排休假</li></ol></details><h3 id="ai生成的帮助理解图表" tabindex="-1">AI生成的帮助理解图表 <a class="header-anchor" href="#ai生成的帮助理解图表" aria-label="Permalink to &quot;AI生成的帮助理解图表&quot;">​</a></h3><details class="details custom-block"><summary>点击展开</summary><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;!-- ✅ deepseek-r1 --&gt;</span></span>
